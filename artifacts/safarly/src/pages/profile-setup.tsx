/**
 * /profile-setup — First-time profile wizard (4 steps).
 * Step 1: About you       (nationality, language, age)
 * Step 2: Food & health   (diet, allergies)
 * Step 3: Accessibility   (toggle)
 * Step 4: Interests
 *
...
export function Toggle({ checked, onChange, label }: { checked: boolean; onChange: () => void; label: string }) {
  return (
    <label style={{
      ...
      transition: "all .2s", userSelect: "none", minHeight: "56px",
    }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      ...
      <div style={{ height: "3px", borderRadius: "2px", background: "var(--sf-border)", overflow: "hidden" }}>
        <div style={{
          height: "100%", borderRadius: "2px", background: "var(--sf-accent)",
...
export function ProfileSetup() {
  ...
  const stepTitles = ["ob.step1.title", "ob.step2.title", "profile.step3.title", "ob.step4.title"];
  const stepSubs   = ["ob.step1.subtitle", "ob.step2.subtitle", "profile.step3.subtitle", "ob.step4.subtitle"];
  ...
  const steps = [
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
          {diets.map((d) => (
            <Chip key={d} label={t(d)} selected={dietary.includes(d)} onClick={() => toggleMulti(dietary, setDietary, d)} />
          ))}
        </div>
      </div>
      <div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <p style={{ fontSize: "0.875rem", color: "var(--sf-text-muted)", lineHeight: 1.6 }}>
        Let us know if you need wheelchair access, step-free routes, or other accommodations
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          <h1 style={{
            fontSize: "clamp(1.375rem, 4vw, 1.75rem)", fontWeight: 800,
            color: "var(--sf-text)", letterSpacing: "-0.02em", marginBottom: "4px",
          }}>
            {t("ob.title")}
          </h1>
      ...
      <div style={{ flex: 1, overflowX: "hidden" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto", padding: "28px 20px" }}>
          <AnimatePresence custom={dir} mode="popLayout">
            ...
            >
              <h2 style={{ fontSize: "1.25rem", fontWeight: 700, color: "var(--sf-text)", marginBottom: "4px" }}>
                {t(stepTitles[step])}
              </h2>
        ...
        <div style={{ maxWidth: "560px", margin: "0 auto", display: "flex", gap: "12px" }}>
          {step > 0 && (
            <button
              ...
              style={{
                minHeight: "52px", padding: "0 20px", borderRadius: "10px",
          ...
          <button
            ...
            style={{
              flex: 1, minHeight: "52px", borderRadius: "10px", border: "none",
              background: "var(--sf-accent)", color: "#0A0E16",
              fontWeight: 700, fontSize: "0.9375rem",
              cursor: "pointer", display: "flex", alignItems: "center",
              justifyContent: "center", gap: "6px", transition: "background .18s",
            }}
...
/* Keep backward compat — old /onboarding imports resolve here */
export { ProfileSetup as Onboarding };
